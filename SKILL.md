...
takeover, failure, continuation, or release request. This root package is the
canonical Ask Park installation; use the clean-clone receipt and installed-path
canary before changing a local selector or active skill.
...
- Root `SKILL.md`, root metadata, README installer, installed skill behavior,
  and live Mini Program systems remain outside this repository implementation.
